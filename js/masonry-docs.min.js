    ...
    function n(e) {
        if (o(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
            ...
            for (var u = h.isBorderBox = "border-box" == n.boxSizing, p = 0; p < g; p++) {
                var f = a[p], m = n[f], s = parseFloat(m);
                h[f] = isNaN(s) ? 0 : s
            }
            var c = h.paddingLeft + h.paddingRight, l = h.paddingTop + h.paddingBottom, b = h.marginLeft + h.marginRight, x = h.marginTop + h.marginBottom, y = h.borderLeftWidth + h.borderRightWidth, v = h.borderTopWidth + h.borderBottomWidth, W = u && d, w = t(n.width);
...
!function (e, t) {
    ...
    r.extend = function (e, t) {
        ...
        var t = [];
        if (Array.isArray(e))t = e; else if (e && "object" == typeof e && "number" == typeof e.length)for (var r = 0; r < e.length; r++)t.push(e[r]); else t.push(e);
        return t
    ...
    return r.htmlInit = function (t, o) {
        r.docReady(function () {
            var u = r.toDashed(o), a = "data-" + u, i = document.querySelectorAll("[" + a + "]"), c = document.querySelectorAll(".js-" + u), f = r.makeArray(i).concat(r.makeArray(c)), d = a + "-options", s = e.jQuery;
...
!function (t, i) {
    ...
    u.constructor = o, u._create = function () {
        ...
        var h = o ? "paddingTop" : "paddingBottom", l = o ? "top" : "bottom", u = o ? "bottom" : "top", d = this.position.y + t[h];
...
!function (t, i) {
    ...
    return e._resetLayout = function () {
        ...
        var e = this.columnWidth += this.gutter, h = this.containerWidth + this.gutter, n = h / e, s = e - h % e, r = s && s < 1 ? "round" : "floor";
        ...
        t.getSize();
        var i = t.size.outerWidth % this.columnWidth, o = i && i < 1 ? "round" : "ceil", e = Math[o](t.size.outerWidth / this.columnWidth);
        ...
        var o = i(t), e = this._getElementOffset(t), h = this._getOption("originLeft"), n = h ? e.left : e.right, s = n + o.outerWidth, r = Math.floor(n / this.columnWidth);
        r = Math.max(0, r);
...
FizzyDocs["fizzy-bear-shirt"] = function (e) {
    var t = new Date(2016, 10, 30), r = Math.round((t - new Date) / 864e5);
...
!function (t) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        for (var t = document.querySelectorAll("[data-js]"), e = 0; e < t.length; e++) {
            var n = t[e], r = n.getAttribute("data-js"), a = i[r] || FizzyDocs[r];
            a && a(n)
        }
    }), i.getItemElement = function () {
        var t = document.createElement("div"), e = Math.random(), n = Math.random(), i = e > .8 ? "grid-item--width3" : e > .6 ? "grid-item--width2" : "", o = n > .8 ? "grid-item--height3" : n > .5 ? "grid-item--height2" : "";
...
MasonryDocs["animate-item-size-responsive"] = function (t) {
    ...
    var s = document.documentElement, o = "string" == typeof s.style.transition ? "transition" : "WebkitTransition", r = {
        WebkitTransition: "webkitTransitionEnd",
        transition: "transitionend"
    }[o], a = t.querySelector(".grid"), d = new Masonry(a, {
...
MasonryDocs["appended-demo"] = function (e) {
    ...
    d.addEventListener("click", function () {
        var e = [MasonryDocs.getItemElement(), MasonryDocs.getItemElement(), MasonryDocs.getItemElement()], d = document.createDocumentFragment();
        d.appendChild(e[0]), d.appendChild(e[1]), d.appendChild(e[2]), n.appendChild(d), t.appended(e)
    })
};
MasonryDocs["destroy-demo"] = function (e) {
    "use strict";
    var o = e.querySelector(".grid"), t = {columnWidth: 80}, n = new Masonry(o, t), r = !0, c = e.querySelector(".toggle-button");
...
MasonryDocs["layout-complete-demo"] = function (t) {
    "use strict";
    var o = t.querySelector(".grid"), e = new Masonry(o, {columnWidth: 80});
...
MasonryDocs["layout-demo"] = function (t) {
    "use strict";
    var i = t.querySelector(".grid"), e = new Masonry(i, {columnWidth: 80});
...
MasonryDocs["prepended-demo"] = function (e) {
    "use strict";
    var n = e.querySelector(".grid"), t = new Masonry(n, {columnWidth: 80}), r = e.querySelector(".prepend-button");
    r.addEventListener("click", function () {
        var e = [MasonryDocs.getItemElement(), MasonryDocs.getItemElement(), MasonryDocs.getItemElement()], r = document.createDocumentFragment();
...
MasonryDocs["remove-complete-demo"] = function (e) {
    "use strict";
    var o = e.querySelector(".grid"), t = new Masonry(o, {columnWidth: 80});
...
MasonryDocs["remove-demo"] = function (e) {
    "use strict";
    var r = e.querySelector(".grid"), t = new Masonry(r, {columnWidth: 80});
...
MasonryDocs.stagger = function (t) {
    "use strict";
    var e = t.querySelector(".grid"), i = new Masonry(e, {columnWidth: 80, stagger: 30});
...
MasonryDocs["stamp-methods-demo"] = function (t) {
    "use strict";
    var e = t.querySelector(".grid"), o = new Masonry(e, {
        itemSelector: ".grid-item",
        columnWidth: 80
    }), r = e.querySelector(".stamp"), n = !1, s = t.querySelector(".stamp-button");
...
MasonryDocs.hero = function (e) {
    ...
    for (var i = e.querySelector(".hero-grid"), r = new Masonry(i, {
        ...
        title: "Graph inside of extension",
        url: "graph.html",
        image: "img/graphExtension.png"
    }, {
        title: "Coming soon...",
        url: "http://iam.beyonce.com/",
        image: "https://img.buzzfeed.com/buzzfeed-static/static/2015-09/10/12/enhanced/webdr10/enhanced-29671-1441901135-4.png?downsize=715:*&output-format=auto&output-quality=auto"
    }, {
        title: "Coming soon...",
        url: "http://www.websterhall.com/timeline/",
        image: "https://img.buzzfeed.com/buzzfeed-static/static/2015-09/1/11/enhanced/webdr10/original-30566-1441122983-22.jpg?downsize=400:*&output-format=auto&output-quality=auto"
    }, {
        title: "Coming soon...e",
        url: "https://img.buzzfeed.com/buzzfeed-static/static/2015-08/26/12/enhanced/webdr12/enhanced-20685-1440605655-5.jpg?downsize=400:*&output-format=auto&output-quality=auto",
        image: "https://img.buzzfeed.com/buzzfeed-static/static/2015-08/27/16/enhanced/webdr13/enhanced-buzz-wide-18154-1440707912-13.jpg?downsize=400:*&output-format=auto&output-quality=auto"
    }, {
        title: "Coming soon...",
        url: "http://resize.thatsh.it/",
        image: "https://img.buzzfeed.com/buzzfeed-static/static/2015-08/26/13/enhanced/webdr03/enhanced-9098-1440609016-1.jpg?downsize=400:*&output-format=auto&output-quality=auto"
    }, {
        title: "Coming soon...",
        url: "http://staff.tumblr.com/archive",
        image: "https://scontent-sea1-1.cdninstagram.com/t51.2885-15/s320x320/e15/10631966_269968583212056_2007010237_n.jpg"
    }, {
        title: "Coming soon...",
        url: "http://www.kristianhammerstad.com/",
        image: "https://img.buzzfeed.com/buzzfeed-static/static/2015-08/27/14/enhanced/webdr07/enhanced-buzz-wide-27979-1440700722-4.jpg?downsize=400:*&output-format=auto&output-quality=auto"
    }, {
        title: "Coming soon...",
        url: "http://www.kristianhammerstad.com/",
        image: "https://img.buzzfeed.com/buzzfeed-static/static/2015-08/27/14/enhanced/webdr07/enhanced-buzz-wide-27979-1440700722-4.jpg?downsize=400:*&output-format=auto&output-quality=auto"
        ...
        image: "https://img.buzzfeed.com/buzzfeed-static/static/2015-08/27/15/enhanced/webdr04/enhanced-buzz-2963-1440703248-8.jpg?downsize=400:*&output-format=auto&output-quality=auto"
...
MasonryDocs["refactor-shirt"] = function (t) {
    "use strict";
    var e = new Date(2016, 1, 10), r = Math.round((e - new Date) / 864e5);
